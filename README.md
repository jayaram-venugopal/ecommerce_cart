...
```
Request:
 curl -X POST http://localhost:3000/api/v1/orders -H 'Accept: */*' -d '{"order_items":[{"product_id":2, "quantity":1}, {"product_id":1, "quantity":1}, {"product_id":2, "quantity":1}, {"product_id":1, "quantity":1}, {"product_id":1, "quantity":1}]}'
...
```sh
    $ rspec spec/services/promotion/cart_discount_spec.rb
    $ rspec spec/services/promotion/product_discount_spec.rb
```
